...
class ModelGen extends Command
{
    ...
    protected function generateTypeDefinitions(): void
    {
        ...
        $modelNames = [];
$interfaces = <<<TS
// This file is auto-generated by the ModelGen command.
// Do not edit this file manually.

// Utility type to ensure only primitive types are included, to avoid
// issues with Inertia's FormDataType auto conversion, among other issues.
export type Pure<T> = {
    [K in keyof T]: T[K] extends Date | string | number | boolean | null ? T[K] : never;
};
